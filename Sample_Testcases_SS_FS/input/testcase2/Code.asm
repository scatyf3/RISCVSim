...
accum = 0
for i in range(7): // Loop limit is 7
    accum += i
    if accum == 21: // Target accumulation is 21
        store(i)
...
// Assembly Code with updated data value comments
0:      LW R2, R0, #4      // 0x00400103 - Load from Mem[R0 + 4] into R2 - Val 7
4:      LW R3, R0, #8      // 0x00800183 - Load from Mem[R0 + 8] into R3 - Val 21
